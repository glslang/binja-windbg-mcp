...
addresses, identities, scores, instructions, and coverage were preserved.
After the alignment fix, two unpaired replacement rows were relabeled `insert`;
their captured endpoints were unchanged.
